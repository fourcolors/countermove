...
| S6 | Tree | 2 | S1, S2, S3 | in-progress | this worktree | - | - |
...
- 2026-08-29: S6 Tree in progress - stdlib `tree/` package (build, score via score.py, hash via provenance.py, recommend, scrape budget) plus `test_tree.py`.
